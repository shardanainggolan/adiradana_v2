...
import kreditMobilImg from '../../public/assets/images/produk/banner/kredit-mobil.webp'
import { NextSeo, FAQPageJsonLd } from 'next-seo';
import { useRouter } from "next/router";
import FormKreditMobil from '../../components/formKreditMobil';

export default function KreditMobil() {
    const canonicalURL = process.env.APP_URL + useRouter().pathname;

	return (
		<>
            <NextSeo
                title="Adira Dana - Pilihan Terbaik untuk Kredit Mobil Tanpa Ribet!"
                description="Dapatkan kredit mobil bekas dengan proses yang mudah dan terpercaya bersama Adira, pilihan tepat untuk memenuhi impian Anda."
                ...
                openGraph={{
                    ...
                    images: [
                        {
                            url: `${process.env.APP_URL}/assets/images/produk/kredit-mobil-600x315.jpg`,
                            width: 600,
                            height: 315,
                            alt: 'Adira Dana: Pilihan Terbaik untuk Kredit Mobil Tanpa Ribet!',
                            type: 'image/jpeg',
                        },
                    ]
                }}
            ...
            <FAQPageJsonLd
                mainEntity={[
                    {
                        questionName: 'Apa yang dimaksud dengan Kredit/Pembiayaan Mobil?',
                        acceptedAnswerText: `
                            <p>
                                Adalah jasa pembiayaan mobil, baru dan bekas yang 
                                diperlukan oleh konsumen, baik perorangan maupun 
            ...
            <section className="pb-md-6 pb-1">
                <Image 
                    src={kreditMobilImg}
                    alt="Kredit Mobil"
                    className="img-fluid"
                        ...
                        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div className="mt-n6 bg-white mb-10 rounded-3 shadow-sm position-relative">
                                <div className="section-scroll p-lg-10 p-5 pb-lg-0 pb-0" id="section-about">
                                    ...
                                    <p>
                                        Adira Finance menawarkan kemudahan memiliki mobil baru dan bekas secara 
                                        kredit untuk berbagai pilihan merek dengan persyaratan dokumen yang mudah, 
                                        proses cepat, pilihan angsuran dan tenor yang sesuai dengan kemampuan Konsumen, 
                                        jaringan pembayaran angsuran yang luas, pilihan perlindungan asuransi yang lengkap, 
                                        sistem penyimpanan BPKB yang aman, serta layanan yang bersahabat di ratusan kantor 
                                        cabang/ perwakilan, dealer, contact center dan media digital.
                                    </p>
                                    <p>
                                                    ...
                                                    <div className="card mb-2">
                                                        <div className="card-header rounded-3 border-bottom-0" id="faqOne">
                                                            <h3 className="mb-0 h4">
                                                                ...
                                                                >
                                                                    ...
                                                                    Apa yang dimaksud dengan Kredit/Pembiayaan Mobil?
                                                                </Link>
                                                            </h3>
                                                        </div>
                                                        <div 
                                                        ...
                                                        >
                                                            <div className="card-body border-top text-dark">
                                                                Adalah jasa pembiayaan mobil, baru dan bekas yang diperlukan oleh konsumen, 
                                                                baik perorangan maupun perusahaan/kelembagaan.
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="card mb-2">
                                                        ...
                                                        >
                                                            <div className="card-body border-top text-dark">
                                                                ...
                                                                <p className="mt-2">
                                                                    Note: khusus kredit mobil bekas, wajib membawa STNK (yang masih berlaku), 
                                                                    BPKB dan Faktur Asli (untuk BPKB yang telah diterima Konsumen)
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
