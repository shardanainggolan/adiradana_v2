...
export default function FormKreditMotor() {
    ...
    const onSubmit = data => {
        ...
        axios.post(`${process.env.BACKEND_URL}/api/kredit-motor`, data)
        .then(res => {
            MySwal.fire({
	...
	return (
		<form className="needs-validation" onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            <div className="mb-3">
                ...
                >
                    <option value="">Pilih Ketersediaan Motor</option>
                    <option value="Belum Tersedia">Motor Belum Tersedia</option>
                    <option value="Sudah Tersedia">Motor Sudah Tersedia</option>
                </select>
            </div>
            ...
            <div className="mb-3">
                ...
                >
                    <option value="">Pilih Asal Motor</option>
                    <option value="Dealer Motor">Dealer Motor</option>
